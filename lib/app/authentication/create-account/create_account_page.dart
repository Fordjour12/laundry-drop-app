...
import 'package:in.laundrydrop.app/app/authentication/create-account/create_account_controller.dart';
...
class CreateAccountPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => CreateAccountPageStateChange(
        onAuthStateChanged: () => context.go('/home'),
        supabaseClient: supabase,
      ),
      child: Consumer<CreateAccountPageStateChange>(
